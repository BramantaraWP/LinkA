...
$updates = [
    "ALTER TABLE users ADD COLUMN user_id INTEGER PRIMARY KEY AUTOINCREMENT",
...
foreach ($updates as $update) {
    try { $db->exec($update); } catch(Exception $e) { }
}
    ...
    switch ($_GET['api']) {
        ...
        case 'update_avatar':
            ...
            if (isset($_FILES['avatar'])) {
                ...
                echo json_encode(['success' => true, 'avatar' => $compressed_filename]);
            } else {
